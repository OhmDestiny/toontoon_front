<template>
  <div>
    ...
    >
      <div class="newcommerbg">
        <div class="row">
          <div class="col text q-pl-md">มาใหม่</div>
          <div class="col-1 textmore cursor-pointer" align="right">
            เพิ่มเติม >
          </div>
        </div>
        ...
        <div class="row">
          <div class="mangabox col" align="center">
            <img
              ...
              style="height: 320px"
            />
            <div class="subtext q-pl-md" align="left">
              Bleach <br />
              บลีช เทพมรณะ
            </div>
            <div class="row">
              <div class="col-5 subtextsm q-pl-md" align="left">
                ตอนที่ 1-366
              </div>
              <div class="col"></div>
              <div class="col-5 subtextsm q-pr-md" align="right">
                30 นาทีที่แล้ว
              </div>
            </div>
          </div>
          ...
          <div class="mangabox col" align="center">
            <img
              ...
              style="height: 320px"
            />
            <div class="subtext q-pl-md" align="left">Rooftop Sword Master</div>
            <br />
